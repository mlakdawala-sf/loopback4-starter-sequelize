...
insert into roles
  (id, name, role_key, permissions) overriding system value
  values
...
insert into tenants
  (id, name, type) overriding system value
  values
  (1, 'application', 'application');

/* Password - test123!@# */
insert into users
  (id, first_name, last_name, username, password, default_tenant) overriding system value
  values
  (1, 'Super', 'Admin', 'super_admin', '$2a$10$TOLMGK43MjbibS8Jap2RXeHl3.4sJcR3eFbms2dBll2LTMggSK9hG', 1);
insert into user_tenants
  (user_id, tenant_id, role_id) overriding system value
  values
  (1, 1, 1);
